...
<body>
    <p class="title">Caffe Mine</p>
    <p class="alamat">Jl.Pahlawan <br> Bandung</p>
    <table class="pos">
        <tr>
    ...
    <hr>
    <p class="Order">Order By: {{ $dtpemesan->nama_pemesan }} <br> No. Meja: {{ $dtpemesan->meja->no_meja }} <br> Order
